                      ...
                      <div class="col-md-12">
                          <div class="card">
                              <div class="card-header">
                                  <strong class="card-title">Tipo Orden Compra</strong>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tipo Orden Compra</h5>
      ...
      <div class="modal-body">   
        ...
        <div class="row">
          ...
          <div class="col-4">
            <input type="text" class="form-control form-control-sm" id="nombre" maxlength="20">
          </div>
        </div>  
      </div>
