...
<!--Modal detalle gasto-->
<div class="modal fade" id="modal_detalle_gasto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Detalle gasto Proyecto</h5>
...
<div class="modal fade" id="modal_detalle_factura" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Detalle facturas</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body">  
            <div class="row">
                <div class="col-12 col-sm-6">
                    <div class="loadpanel_factura"></div>
                    <div id="resultados_factura"></div>
                </div>
                <div class="col-12 col-sm-6">
                    <label>Visualización de la factura</label>
                    <div class="visualiza-factura"></div>
                </div>
            </div> 
