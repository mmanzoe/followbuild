    ...
    $.ajax({
        ...
        success: function(Data){
            ...
            for(var x=0;x<Data.length;x++){
                registros.push({"id":Data[x]["id"], "nombre":Data[x]["nombre"], "descripcion":Data[x]["descripcion"], "accion":"<a href='' class='actualizar' id='"+Data[x]['id']+"', nombre='"+Data[x]["nombre"]+"', descripcion='"+Data[x]["descripcion"]+"' ><i class='fa fa-edit' title='editar'></i> </a>"})	
			}
