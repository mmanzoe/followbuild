...
$query = "SELECT detalle_pago.*, fcen.serie, fcen.factura, fcen.monto, ctpp.nombre as nom_pago, cat_banco.nombre as nom_banco 
FROM detalle_pago_cliente as detalle_pago 
INNER JOIN factura_cliente_encabezado AS fcen ON (detalle_pago.id_factura = fcen.id) 
