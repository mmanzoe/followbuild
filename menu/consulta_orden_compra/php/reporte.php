...
$consulta = "SELECT oce.*, cat_proveedor.nombre as nom_proveedor, fac_en.documento, fac_en.serie, ceoc.nombre as nombre_estado FROM orden_compra_encabezado as oce
...
for($n=0; $n<mysqli_num_rows($resultados); $n++){
	$fila = mysqli_fetch_assoc($resultados);
        ...
        if($fila['documento'] == NULL){
            ...
            $rutafactura = '<a href="../ingreso_factura_proveedor/factura/'.$fila['serie'].$fila['documento'].$fila['cod_proveedor'].'.pdf" alt="visualiza factura" target="_blank"><span class="fa fa-download"></span></a>';
            $accion = '';
