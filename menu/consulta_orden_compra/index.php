  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content modal-">
      ...
      <div class="modal-body">           
        ...
        <div class="form-group row">
          <label class="col-3 col-form-label">Tipo Orden</label>
          <div class="col-8">
            <select class="form-control form-control-sm" id="tipo_orden">
                <option value="">TODO</option>
        ...
        <div class="form-group row">
          <label class="col-3 col-form-label">Fecha Inicial</label>
          <div class="col-8">
...
<!--Modal para listar detalle orden-->
<div class="modal fade" id="modal-detalle-pedido" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content modal-">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Detalle Pedido</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">       
        <div class="row mt-3">
          <div class="col-12 resultadodetalle">
