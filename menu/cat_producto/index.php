    ...
    <div class="modal-content">
      ...
      <div class="modal-body">   
        <div class="row">
          ...
          <div class="col-4">
            <input type="text" class="form-control form-control-sm" id="codigo" maxlength="10">
          </div>
        </div>   
        <div class="row">
          <div class="col-4 offset-1">
        ...
        <div class="row">
          ...
          <div class="col-4">
            <input type="text" class="form-control form-control-sm" id="descripcion" maxlength="80" required>
          </div>
        </div> 
        <div class="row">
          <div class="col-4 offset-1">
          ...
          <div class="col-4">
            <input type="text" class="form-control form-control-sm" id="precio" required>
          </div>
        </div>   
      </div>
