                      ...
                      <div class="col-md-12">
                          <div class="card">
                              <div class="card-header">
                                  <strong class="card-title">Maquinaria</strong>
                                  ...
                                  <table id="registros" class="resultados" 
                                      ...
                                      <thead>
                                          <tr>
                                              ...
                                              <th data-field="tipo_placa">Tipo Placa</th>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Maquinaria</h5>
      ...
      <div class="modal-body">   
        <div class="row">
          ...
          <div class="col-4">
            <select class="form-control form-control-sm" id="tipo_maquinaria"></select>
          </div>
        </div>   
        <div class="row">
          <div class="col-4 offset-1">
          ...
          <div class="col-4">
            <select class="form-control form-control-sm" id="tipo_placa"></select>
          </div>
        </div>
        <div class="row">
          <div class="col-4 offset-1">
          ...
          <div class="col-4">
            <input type="text" class="form-control form-control-sm" id="placa" maxlength="6" required>
          </div>
        </div>
        <div class="row">
          <div class="col-4 offset-1">
          ...
          <div class="col-4">
            <select class="form-control form-control-sm" id="marca"></select>
          </div>
        </div>
        <div class="row">
          <div class="col-4 offset-1">
          ...
          <div class="col-4">
            <select class="form-control form-control-sm" id="linea" required></select>
          </div>
        </div>
        <div class="row">
          <div class="col-4 offset-1">
          ...
          <div class="col-4">
            <input type="text" class="form-control form-control-sm" id="modelo" maxlength="4" required>
          </div>
        </div>  
        <div class="row">
          <div class="col-4 offset-1">
          ...
          <div class="col-4">
            <input type="text" class="form-control form-control-sm" id="descripcion" maxlength="50" required>
          </div>
        </div>     
      </div>
