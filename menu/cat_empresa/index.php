        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-2 offset-10">
                  <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal_add_empresa"><span class="fa fa-plus"></span> Nuevo</button>
                </div>
            </div>
...
<div class="modal fade" id="modal_add_empresa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
