...
$update = "UPDATE orden_compra_detalle SET cantidad='".$cantidad."', valor='".$valor."' WHERE id='".$idregistro."'";
...
if($resultados && $resulupdate){
    ...
    $return = Array('ok' => FALSE, 'msg' => "Error al actualizar el registro!!". $update);
}
